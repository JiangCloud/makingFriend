layui.use(['element', 'form', 'layer', 'upload'], function () {
    ...
    $(document).on("click",".timo-add-btn",function (e) {
       ...
       var userId= $("input[name='userId']").val();
        ...
        var groupId=$("#groupId").val();
       $.get(url,{userId:userId,groupId:groupId},function (result) {
    ...
    upload.render({
        ...
        ,accept:'image,video'
        ,field: 'image'//文件域的字段名
        ,acceptMime: 'image/*,video/*' //选择文件类型
        ,exts: 'jpg|jpeg|png|gif|mp4' //支持的图片格式
        ,size:10240
            ...
            obj.preview(function (index, file, result) {
               ...
               /* show.append("<div class='upload-item'><video src='"+ result +"' />" +
                ...
                show.append(head +
                    ...
                    "<input id='thumbSecret' type='hidden' name='thumbSecret'/>"+
                    "<i class='upload-item-close layui-icon layui-icon-close'></i></div>");
            });
        }
            ...
            var interval = window.setInterval(function(){
                ...
                if(hide.length > 0){
                    ...
                    if (res.code === 200) {
                        ...
                        $("#share_secret").val(res.data['share_secret']);
                        $("#uri").val(res.data['uri']);
                        $("#thumb").val(res.data['thumb']);
                        $("#thumbSecret").val(res.data['thumbSecret']);
