...
public class MainController{
    ...
    public String main(Model model){
        // 获取当前登录的用户
        Users user = ShiroUtil.getSubject();
    ...
    public ResultVo userPicture(@RequestParam("picture") MultipartFile picture){
        ...
        if(imageResult.getCode().equals(ResultEnum.SUCCESS.getCode())){
            Users subject = ShiroUtil.getSubject();
    ...
    @RequiresPermissions("index")
    @ResponseBody
    public ResultVo userInfo(@Validated UserValid valid, Users user){

        // 复制保留无需修改的数据
        Users subUser = ShiroUtil.getSubject();
