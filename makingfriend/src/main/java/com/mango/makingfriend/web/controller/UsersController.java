...
import com.linln.modules.system.domain.Users;
import com.linln.modules.system.repository.UserRepository;
import com.linln.modules.system.service.RoleService;
import com.linln.modules.system.service.UserService;
import com.mango.makingfriend.web.validator.UserValid;
...
public class UsersController {
    ...
    public String index(Model model, Users user) {
        ...
        // 获取用户列表
        Page<Users> list = userService.getPageList(user);
    ...
    public String toEdit(@PathVariable("id") Users user, Model model) {
    ...
    public ResultVo save(@Validated UserValid valid, @EntityParam Users user) {
        ...
        if (user.getId() != null) {
            ...
            Users beUser = userService.getById(user.getId());
    ...
    public String toDetail(@PathVariable("id") Users user, Model model) {
        model.addAttribute("user", user);
    ...
    public ResultVo editPassword(String password, String confirm,
                                 ...
                                 @RequestParam(value = "ids", required = false) List<Users> users) {
    ...
    public String toRole(@RequestParam(value = "ids") Users user, Model model) {
        // 获取指定用户角色列表
    ...
    public ResultVo auth(
            @RequestParam(value = "id", required = true) Users user,
    ...
    public void exportExcel() {
        ...
        ExcelUtil.exportExcel(Users.class, userRepository.findAll());
    }
