...
public class VideoImage {
   ...
   /* public static void main(String[] args) throws Exception {
        System.out.println(randomGrabberFFmpegImage("C:/Users/Public/Pictures/Sample Pictures/IMG_2485.MP4", 2));
    }*/
     ...
     * @throws Exception
     */
    public  String randomGrabberFFmpegImage(String filePath, int mod)
            throws Exception {
     ...
     * @return：缩略图的存放路径
     */
    private  String getImagePath(String filePath, int index){
     ...
     */
    public  void doExecuteFrame(Frame f, String targerFilePath) {
     ...
     * @return:随机数集合
     */
    public  List<Integer> random(int baseNum, int length) {
